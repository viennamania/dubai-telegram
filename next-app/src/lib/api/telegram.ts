...
export async function insertMessageByUseridAndStorecodeGrapeBot(
    {
        center,
        category,
        userid,
    ...
    console.log("insertMessageByUseridAndStorecodeGrapeBot", {
        center,
        category,
        userid,
        storecode,
    ...
    const user = await client.db('dubai').collection('usersGrapeBot').findOne(
        {
            ////storecode: storecode,
            nickname: userid,
        },
...
export async function insertMessageByUseridAndStorecodeOrangeBot(
    {
        center,
        category,
        userid,
...
export async function insertMessageByUseridAndStorecodeBlueberryBot(
    {
        center,
        category,
        userid,
    ...
    console.log("insertMessageByUseridAndStorecodeBlueberryBot", {
        center,
        category,
        userid,
        storecode,
    ...
    const user = await client.db('dubai').collection('usersBlueberryBot').findOne(
        {
            ////storecode: storecode,
            nickname: userid,
        },
...
export async function insertMessageByUseridAndStorecodeKiwiBot(
    {
        center,
        category,
        userid,
    ...
    const user = await client.db('dubai').collection('usersKiwiBot').findOne(
        {
            ////storecode: storecode,
            nickname: userid,
        },
