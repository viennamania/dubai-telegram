...
export async function insertOne(data: any) {
    ...
    const collectionUserTransfers = client.db('dubai').collection('userTransfersDubai');

    
    const collection = client.db('dubai').collection('transfersDubai');
    ...
    */
    ...
    if (userToAddress && userToAddress.walletAddress) {
        ...
        // if data.fromAddress is escrow.walletAddress of ordersDubai collection

        const collectionOrders = client.db('dubai').collection('ordersDubai');
