    ...
    */
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch("/api/userMangoBot/getUser", {
                method: "POST",
                headers: {
    ...
    const checkNicknameIsDuplicate = async ( nickname: string ) => {
        ...
        const response = await fetch("/api/userMangoBot/checkUserByNickname", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setUserData = async () => {
        ...
        if (nicknameEdit) {
            ...
            const response = await fetch("/api/userMangoBot/updateUser", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            const response = await fetch("/api/userMangoBot/setUserVerified", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const setUserTelegramId = async () => {
        ...
        const response = await fetch("/api/userMangoBot/updateUserTelegramId", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const updateUserStorecode = async () => {
        ...
        const response = await fetch("/api/userMangoBot/updateUserStorecode", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setSellerInfo = async () => {
        ...
        const response = await fetch("/api/userMangoBot/updateSellerSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const checkAuthValue = async () => {
        ...
        const response = await fetch("/api/userMangoBot/updateSellerConfirmSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
