    ...
    */
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch("/api/userBlueberryBot/getUser", {
                method: "POST",
                headers: {
    ...
    const checkNicknameIsDuplicate = async ( nickname: string ) => {
        ...
        const response = await fetch("/api/userBlueberryBot/checkUserByNickname", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setUserData = async () => {
        ...
        if (nicknameEdit) {
            ...
            const response = await fetch("/api/userBlueberryBot/updateUser", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            const response = await fetch("/api/userBlueberryBot/setUserVerified", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const setUserTelegramId = async () => {
        ...
        const response = await fetch("/api/userBlueberryBot/updateUserTelegramId", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const updateUserStorecode = async () => {
        ...
        const response = await fetch("/api/userBlueberryBot/updateUserStorecode", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setSellerInfo = async () => {
        ...
        const response = await fetch("/api/userBlueberryBot/updateSellerSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const checkAuthValue = async () => {
        ...
        const response = await fetch("/api/userBlueberryBot/updateSellerConfirmSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
