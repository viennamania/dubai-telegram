    ...
    */
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch("/api/userGrapeBot/getUser", {
                method: "POST",
                headers: {
    ...
    const checkNicknameIsDuplicate = async ( nickname: string ) => {
        ...
        const response = await fetch("/api/userGrapeBot/checkUserByNickname", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setUserData = async () => {
        ...
        if (nicknameEdit) {
            ...
            const response = await fetch("/api/userGrapeBot/updateUser", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            const response = await fetch("/api/userGrapeBot/setUserVerified", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const setUserTelegramId = async () => {
        ...
        const response = await fetch("/api/userGrapeBot/updateUserTelegramId", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const updateUserStorecode = async () => {
        ...
        const response = await fetch("/api/userGrapeBot/updateUserStorecode", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setSellerInfo = async () => {
        ...
        const response = await fetch("/api/userGrapeBot/updateSellerSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const checkAuthValue = async () => {
        ...
        const response = await fetch("/api/userGrapeBot/updateSellerConfirmSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
