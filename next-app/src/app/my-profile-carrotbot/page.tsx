    ...
    */
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch("/api/userCarrotBot/getUser", {
                method: "POST",
                headers: {
    ...
    const checkNicknameIsDuplicate = async ( nickname: string ) => {
        ...
        const response = await fetch("/api/userCarrotBot/checkUserByNickname", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setUserData = async () => {
        ...
        if (nicknameEdit) {
            ...
            const response = await fetch("/api/userCarrotBot/updateUser", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            const response = await fetch("/api/userCarrotBot/setUserVerified", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const setUserTelegramId = async () => {
        ...
        const response = await fetch("/api/userCarrotBot/updateUserTelegramId", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const updateUserStorecode = async () => {
        ...
        const response = await fetch("/api/userCarrotBot/updateUserStorecode", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setSellerInfo = async () => {
        ...
        const response = await fetch("/api/userCarrotBot/updateSellerSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const checkAuthValue = async () => {
        ...
        const response = await fetch("/api/userCarrotBot/updateSellerConfirmSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
