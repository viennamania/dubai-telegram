    ...
    */
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch("/api/userLemonBot/getUser", {
                method: "POST",
                headers: {
    ...
    const checkNicknameIsDuplicate = async ( nickname: string ) => {
        ...
        const response = await fetch("/api/userLemonBot/checkUserByNickname", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setUserData = async () => {
        ...
        if (nicknameEdit) {
            ...
            const response = await fetch("/api/userLemonBot/updateUser", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            const response = await fetch("/api/userLemonBot/setUserVerified", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const setUserTelegramId = async () => {
        ...
        const response = await fetch("/api/userLemonBot/updateUserTelegramId", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const updateUserStorecode = async () => {
        ...
        const response = await fetch("/api/userLemonBot/updateUserStorecode", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const setSellerInfo = async () => {
        ...
        const response = await fetch("/api/userLemonBot/updateSellerSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const checkAuthValue = async () => {
        ...
        const response = await fetch("/api/userLemonBot/updateSellerConfirmSnt", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
